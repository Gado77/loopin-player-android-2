...
export const COMMAND_LABELS:Record<PlayerCommandType,string>={GET_STATUS:"Atualizar status",SYNC_NOW:"Sincronizar agora",RELOAD_PLAYLIST:"Recarregar playlist"};
